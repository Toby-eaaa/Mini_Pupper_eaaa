...
################ ADDED FUNCTION##########################
# Will write the pupper state to a txt file in the same folder. 
# 0 = Deactivated
# 1 = Activated
# Other programs can then read the pupper state from this txt file
...
# On run_robot startup, the state is set to 0: Deactivated
